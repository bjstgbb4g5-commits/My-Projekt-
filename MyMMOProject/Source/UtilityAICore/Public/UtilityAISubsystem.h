...
UCLASS()
class UTILITYAICORE_API UUtilityAISubsystem : public UWorldSubsystem, public FTickableGameObject
{
    GENERATED_BODY()
...
public:
    ...
    UUtilityAIManager* GetManager() const { return Manager; }

private:
    UPROPERTY(Transient)
    UUtilityAIManager* Manager;
